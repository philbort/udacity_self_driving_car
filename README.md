...
N/A | [TensorFlow Lab](https://github.com/udacity/CarND-TensorFlow-Lab) | [Python](TensorFlow_Lab/lab.ipynb) | [Neural Network](https://en.wikipedia.org/wiki/Artificial_neural_network), [Min-Max Scaling](http://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.MinMaxScaler.html) | [TensorFlow](https://www.tensorflow.org/), [Scikit-Learn](http://scikit-learn.org/), [tqdm](https://github.com/noamraph/tqdm)
...
N/A | [Keras Lab](Keras_Lab/) | [Python](Keras_Lab/traffic-sign-classification-with-keras.ipynb)
